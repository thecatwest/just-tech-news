...
User.init(
  ...
  {
    // to use hooks to modify User model,we must pass in another object labelled hooks to User.init
    // hooks property is added to second obj in User.init() (nested level is important)
    hooks: {
